...
# Novo Import da Sidebar
from view.admin.sidebar_view import AdminSidebar

class AdminPainelView:
    """
    Painel administrativo principal do Vitta Vision no padrão SaaS.
    Navegação via Sidebar isolada e Dashboard analítico na home.
    """
    ...
    def render(self):
        ...
        # =====================================================
        # RENDERIZAR SIDEBAR PADRONIZADA
        # =====================================================
        menu_selecionado = AdminSidebar().render()
    ...
    def render_dashboard_home(self, db):
        ...
        # O CSS aqui agora contém APENAS o estilo dos cards
        st.html("""
        <style>
            .saas-card {
